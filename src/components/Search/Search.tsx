...
const Search: React.FC = () => {
 ...
 useEffect(() => {
  const isValid = Boolean(companyINN && documentCount && startDate && endDate);
    ...
    <div className="search-content">
      <div className="search-title-block">
        <div className="search-title-text">
          <h1 className="h1-search-page">
            Найдите необходимые <br />
            данные в пару кликов.
          </h1>
          <p className="p-search-page-title-block">
            Задайте параметры поиска. <br />
            Чем больше заполните, тем точнее поиск
          </p>
        </div>
        <img
          className="search-page-small-picture-sheet"
          src={search_page_small_picture_sheet}
          alt="Paper image"
        />
        <img
          className="search-page-small-picture-folders"
      ...
      <div className="search-block">
        ...
        <img
          className="search-page-large-picture"
